...
const MainPg = () => {
  ...
  return (
    ...
    >
      <Navbar />
      <div className="flex items-center justify-center lg:space-y-12 space-y-16 h-[89.9%] flex-col">
        ...
        <div className='flex justify-center md:space-x-5 items-center w-full'>
          ...
          <Image
            className="max-sm:w-[70px] max-md:w-[100px] max-lg:w-[85px]"
            src={hourglass}
            alt=""
            width={130}
          />
          <div className="flex flex-col items-center justify-center">
            <div className="lg:text-[65px] md:text-[53px] sm:text-[40px] text-[40px] island-moments-regular leading-none text-center">
              Time Left To Register
            </div>
            <div className="lg:text-[110px] md:text-[95px] sm:text-[80px] text-[60px] abhaya-libre-regular text-[#727968] sm:leading-[55px] leading-[40px] lg:leading-[75px] text-center">
              00:00:00
            </div>
          </div>
          <Image
