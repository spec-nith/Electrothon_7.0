...
const Cannonball3 = ({ style, reflectionPosition = 'top-left' }) => {
  ...
  return (
    <div
      className="relative w-48 h-48 bg-gradient-radial from-gray-700 via-[#1b1b2f] to-black rounded-full shadow-lg shadow-black"
      style={style}
    >
