    ...
    <div className="prizes-section w-full min-h-screen bg-cover bg-center py-6 md:py-8 lg:py-10">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12 px-4 md:px-6 lg:px-8 w-full max-w-6xl">
          {/* Second Prize */}
          <div
            className="order-2 md:order-1 flex flex-col items-center justify-center bg-black/70 p-4 md:p-6 lg:p-8"
            style={{
          ...
          {/* First Prize */}
          <div
            className="order-1 md:order-2 flex flex-col items-center justify-center bg-black/70 p-4 md:p-6 lg:p-10"
            style={{
          ...
          {/* Third Prize */}
          <div
            className="order-3 md:order-3 flex flex-col items-center justify-center bg-black/70 p-4 md:p-6 lg:p-8"
            style={{
